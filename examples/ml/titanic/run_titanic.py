...
m: cflearn.ml.MLCarefreePipeline = cflearn.api.fit_ml(train_file, **kwargs)  # type: ignore
...
m3: cflearn.ml.MLCarefreePipeline = cflearn.api.load(cflearn.api.pack(latest))
